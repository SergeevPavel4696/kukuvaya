import {
    ...
    polPostrNormOtnUsk, polPostrOtnUsk, polPostrUskParyPolz, polPostrSkTochkiKrivKor, polPostrUskTochkiKrivKor
} from "../pol-tag-2kin.js";
import {planSk, planUsk} from "./ris.js";
import {
    polAA, polAAX, polAAY, polAB, polABA, polABAn, polABAt, polABY, polACX, polACY, polAD, polADC,
    polADCn, polADCt, polADX, polAS2, polAS2X, polAS2Y, polAS4, polAS4X, polAS4Y, polE2, polE4, polFI2,
    polFI4, polSBY, polSDX, polVA, polVAX, polVAY, polVB, polVBA, polVBY, polVC, polVCX, polVCY, polVD,
    polVDC, polVDX, polVS2, polVS2X, polVS2Y, polVS4, polVS4X, polVS4Y, polW2, polW4
} from "./analiz.js";
import {aktInterPu, Pi, pol4Znach, zadMuSk, zadMuUsk, zadPerVHran, zadPlNaStr, zadPole,} from "../utils.js";
import {
    polTekVr, polTokAB, polTokAS2, polTokCD, polTokCS4, polTokK, polTokL012, polTokMuA, polTokMuDiA,
    polTokMuDiS, polTokMuDiV, polTokMuV, polTokN1, polTokNDv, polTokOA, polTokOC, polTokTakt,
...
const
    OA = polTokOA() / 1000, AB = polTokAB() / 1000, AS2 = polTokAS2() / 1000, OC = polTokOC() / 1000,
    CD = polTokCD() / 1000, CS4 = polTokCS4() / 1000, FI2 = polFI2(t), FI4 = polFI4(t);
const n1 = polTokN1(), ndw = polTokNDv();
const
    skW1 = polTokW(), skW2 = polW2(t), skW4 = polW4(t), skWDv = polTokWDv(t), skA = polVA(t), skBA = polVBA(t),
    skB = polVB(t), skS2 = polVS2(t), skC = polVC(t), skDC = polVDC(t), skD = polVD(t), skS4 = polVS4(t),
    skAX = polVAX(t), skAY = polVAY(t), skS2X = polVS2X(t), skS2Y = polVS2Y(t), skBY = polVBY(t),
    skCX = polVCX(t), skCY = polVCY(t), skS4X = polVS4X(t), skS4Y = polVS4Y(t), skDX = polVDX(t);
const
    uskE2 = polE2(t), uskE4 = polE4(t), uskA = polAA(t), uskBAn = polABAn(t), uskBAt = polABAt(t), uskBA = polABA(t),
    uskB = polAB(t), uskS2 = polAS2(t), uskDCn = polADCn(t), uskDCt = polADCt(t), uskDC = polADC(t), uskD = polAD(t),
...
const contentTag =
    ...
    pol2_1([
        ...
        polPostrSkTochkiKrivKor("postr_VC", "C", "O", "A", OC, OA, 180),
    ...
    pol2_3([
        ...
        polPostrUskTochkiKrivKor("postr_AC", "C", "O", "A", OC, OA, 180),
...
const
    ...
    risVS2A = elNaStr("sk_VS2A"), risVS2 = elNaStr("sk_VS2"), risVC = elNaStr("sk_VC"),
    risVDC = elNaStr("sk_VDC"), risVD = elNaStr("sk_VD"), risVS4C = elNaStr("sk_VS4C"),
    risVS4 = elNaStr("sk_VS4");
...
zadPlNaStr(
    [skAX, skCX, skDX], [skAY, skBY, skCY], 500,
...
zadPlNaStr(
    [uskAX, uskCX, uskDX, uskAX - uskBAn * Math.cos(FI2), uskCX - uskDCn * Math.cos(FI4)],
    [uskAY, uskBY, uskCY, uskAY - uskBAn * Math.sin(FI2), uskCY - uskDCn * Math.sin(FI4)], 500,
...
postrKinDi(KOL, razmetka, TAKT, TOCH, per, sk, usk, polV, polA, skNakl, uskNakl, skGor, uskGor, osPer, osSk, osUsk, [
    [diPer1, polSBY, diSk1, polVBY, diUsk1, polABY, 0], [diPer2, polSDX, diSk2, polVDX, diUsk2, polADX, 0]
]);
