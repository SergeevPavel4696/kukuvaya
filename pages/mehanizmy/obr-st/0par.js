...
import {
    polFI1A, polFI1C, polFI2, polFI4, polLev5, polLevKr, polNizh3, polNizhKr, polPravKr, polSAX, polSAY,
    polSBY, polSCX, polSCY, polSDX, polSS2X, polSS2Y, polSS4X, polSS4Y, polVerhKr
} from "./analiz.js";
import {
    polTokOA, polTokAB, polTokCD, polTokFi, polTokK, polTokM1, polTokM2, polTokM3, polTokM4, polTokM5, polTokJs1,
    polTokJs2, polTokJs4, polTokN1, polTokToch, tokOA, tokAB, tokCD, tokFi, tokM1, tokM2, tokM3, tokM4, tokM5,
    tokJS1, tokJS2, tokJS4, tokK, tokN1, tokToch, polTokNerav, tokNerav, polTokAS2, polTokP3Max, polTokP5Max,
    tokP3Max, tokP5Max, polTokCS4, tokAS2, tokCS4, polTokOC, tokOC, polTokNDv, polTokJsDv, tokNDv, tokJSDv,
