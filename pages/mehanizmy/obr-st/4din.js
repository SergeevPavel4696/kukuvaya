...
import {
    ...
    polTekVr, tokMuDe, tokMuFi1, tokMuFi2, tokMuJp, tokMuMp, tokOtrDe, polTokJsDv, polTokWDv,
...
import {
    ...
    polUgG3VB, polUgP3VB, polJp, polMp, polMpMass, polMdv, polUgPsi, polG5, polVD, polUgG5VD, polUgP5VD
} from "./analiz.js";
...
const
    ...
    jsdv = pol4Znach(polTokJsDv());
//Скорости и угловые скорости звеньев.
const
    skS2 = pol4Znach(polVS2(t)), skB = pol4Znach(polVB(t)), skS4 = pol4Znach(polVS4(t)),
    skD = pol4Znach(polVD(t)), skW1ch = polW1(t), skW1 = pol4Znach(skW1ch),
    skW2 = pol4Znach(polW2(t)), skW4 = pol4Znach(polW4(t)), skWDv = pol4Znach(polTokWDv());
...
const
    ...
    g5vd = pol4Znach(polUgG5VD(t)), p3vb = pol4Znach(polUgP3VB(t)), p5vd = pol4Znach(polUgP5VD(t));
...
const contentTag =
    pol4() +
    pol4_1(
        [[2, 2, m2, skS2], [3, "B", m3, skB], [4, 4, m4, skS4], [5, "D", m5, skD]],
        [[1, 1, js1, skW1], [2, 2, js2, skW2], [4, 4, js4, skW4], ["дв", "дв", jsdv, skWDv]],
        Jp, skW1) +
    pol4_2(
        [[2, 2, g2, skS2, g2vs2], [3, "B", g3, skB, g3vb], [4, 4, g4, skS4, g4vs4], [5, "D", g5, skD, g5vd]],
        [[3, "B", p3, skB, p3vb], [5, "D", p5, skD, p5vd]],
        Mp, skW1) +
