...
import {
    polFI1A, polFI1C, polFI2, polFI4, polLevKr, polNizhKr, polPravKr, polSAX, polSAY,
...
const mehRis = elNaStr("meh_ris"), st1 = elNaStr("st_1"), st3 = elNaStr("st_3"), st5 = elNaStr("st_5"),
    shO = elNaStr("sh_O"), shA = elNaStr("sh_A"), shC = elNaStr("sh_C"), shB = elNaStr("sh_B"), shD = elNaStr("sh_D"),
    zv1A = elNaStr("zv_OA"), zv2 = elNaStr("zv_AB"), zv3 = elNaStr("pol3"), zv1C = elNaStr("zv_OC"),
...
let planPolTag =
    ...
    polTagOpSk(null, 50, 90, OA + AB, false, false, null, null) +
    polTagOpSk(50, null, null, OC + CD, false, true, null, null);
for (let i = 0; i < KOL; i++) {
    const t = i * TAKT / KOL;
    planPolTag +=
