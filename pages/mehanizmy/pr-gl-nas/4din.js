...
import {
    polTokJs1, polTokJs2, polTokJs4, polTokK, polTokM2, polTokM3, polTokM4, polTokM5, polTokMuDE, polTokMuFI1,
    polTokMuFI2, polTokMuJP, polTokMuMP, polTokNerav, polTokOtrDe, polTekVr, tokMuDe, tokMuFi1, tokMuFi2,
    tokMuJp, tokMuMp, tokOtrDe, polTokJsDv, polTokWDv, polTokJs3, polTokJs5, polTokMSht, polTokMPr, polTokMZh
} from "./local_storage.js";
import {pol4Znach, pol4ZnachVek, polDMahSr, polJMah, zadPerVHran, zadPole} from "../utils.js";
import {
    polVS2, polVS4, polW1, polW2, polW4, polG2, polG4, polG3, polUgG2VS2, polUgG4VS4, polJp,
    polMp, polMpMass, polMdv, polUgPsi, polG5, polVS3, polVS5, polVDY, polVF, polW3, polW5,
    polGSht, polGPr, polGZh, polUgG3VS3, polUgG5VS5, polUgGShtVD, polUgGPrVF, polUgGZhidVD
} from "./analiz.js";
...
const
    ...
    msht = pol4Znach(polTokMSht()), mpr = pol4Znach(polTokMPr()), mzh = pol4Znach(polTokMZh()),
    js1 = pol4Znach(polTokJs1()), js2 = pol4Znach(polTokJs2()), js3 = pol4Znach(polTokJs3()),
    js4 = pol4Znach(polTokJs4()), js5 = pol4Znach(polTokJs5()), jsdv = pol4Znach(polTokJsDv());
//Скорости и угловые скорости звеньев.
const
    skS2 = pol4Znach(polVS2(t)), skS3 = pol4Znach(polVS3(t)), skS4 = pol4Znach(polVS4(t)),
    skS5 = pol4Znach(polVS5(t)), skD = pol4Znach(polVDY(t)), skF = pol4Znach(polVF(t)),
    skW1ch = polW1(t), skW1 = pol4Znach(skW1ch), skW2 = pol4Znach(polW2(t)), skW3 = pol4Znach(polW3(t)),
    skW4 = pol4Znach(polW4(t)), skW5 = pol4Znach(polW5(t)), skWDv = pol4Znach(polTokWDv());
//Веса звеньев и силы полезного сопротивления.
const
    g2 = pol4Znach(polG2()), g3 = pol4Znach(polG3()), g4 = pol4Znach(polG4()), g5 = pol4Znach(polG5()),
    gsht = pol4Znach(polGSht()), gpr = pol4Znach(polGPr()), gzh = pol4Znach(polGZh(null, t));
//Углы между силами и скоростями.
const
    g2vs2 = pol4Znach(polUgG2VS2(t)), g3vs3 = pol4Znach(polUgG3VS3(t)), g4vs4 = pol4Znach(polUgG4VS4(t)),
    g5vs5 = pol4Znach(polUgG5VS5(t)), gshtvd = pol4Znach(polUgGShtVD(t)), gprvf = pol4Znach(polUgGPrVF(t)),
    gzhvd = pol4Znach(polUgGZhidVD(t));
...
const contentTag =
    pol4() +
    pol4_1([
        [2, 2, m2, skS2], [3, 3, m3, skS3], [4, 4, m4, skS4], [5, 5, m5, skS5],
        ["шт", "Dверт", msht, skD], ["пр", "F", mpr, skF], ["жид", "Dверт", mzh, skD]
    ], [
        [1, 1, js1, skW1], [2, 2, js2, skW2], [3, 3, js3, skW3], [4, 4, js4, skW4], [5, 5, js5, skW5],
        ["дв", "дв", jsdv, skWDv]
    ], Jp, skW1) +
    pol4_2([
            [2, 2, g2, skS2, g2vs2], [3, 3, g3, skS3, g3vs3], [4, 4, g4, skS4, g4vs4], [5, 5, g5, skS5, g5vs5],
            ["шт", "Dверт", gsht, skD, gshtvd], ["пр", "F", gpr, skF, gprvf], ["жид", "Dверт", gzh, skD, gzhvd]
        ], null,
        Mp, skW1) +
