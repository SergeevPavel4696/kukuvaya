import {
    ...
    polPostrUskParyPolz, polPostrSkTochkiKrivKor, polPostrUskTochkiKrivKor
} from "../pol-tag-2kin.js";
import {planSk, planUsk} from "./ris.js";
import {
    polAA, polAAX, polAAY, polAB, polABA, polABAn, polABAt, polABX, polABY, polAC, polACX, polACY, polAD, polADC,
    polADCn, polADCt, polADX, polADY, polAS2, polAS2X, polAS2Y, polAS4, polAS4X, polAS4Y, polE2, polE4, polFI2,
    polFI4, polSBX, polSDX, polVA, polVAX, polVAY, polVB, polVBA, polVBX, polVBY, polVC, polVCX, polVCY, polVD,
    polVDC, polVDX, polVDY, polVS2, polVS2X, polVS2Y, polVS4, polVS4X, polVS4Y, polW2, polW4
} from "./analiz.js";
import {aktInterPu, Pi, pol4Znach, zadMuSk, zadMuUsk, zadPerVHran, zadPlNaStr, zadPole,} from "../utils.js";
import {
    polTekVr, polTokAB, polTokAS2, polTokCD, polTokCS4, polTokK, polTokL012, polTokMuA,
    polTokMuDiA, polTokMuDiS, polTokMuDiV, polTokMuV, polTokN1, polTokOA, polTokOC, polTokTakt,
...
const
    ...
    OC = polTokOC() / 1000, CD = polTokCD() / 1000, CS4 = polTokCS4() / 1000,
    FI2 = polFI2(t), FI4 = polFI4(t);
const n1 = polTokN1();
const
    skW1 = polTokW(), skW2 = polW2(t), skW4 = polW4(t),
    skA = polVA(t), skBA = polVBA(t), skB = polVB(t), skS2 = polVS2(t),
    skC = polVC(t), skDC = polVDC(t), skD = polVD(t), skS4 = polVS4(t),
    skAX = polVAX(t), skAY = polVAY(t), skS2X = polVS2X(t), skS2Y = polVS2Y(t), skBX = polVBX(t), skBY = polVBY(t),
    skCX = polVCX(t), skCY = polVCY(t), skS4X = polVS4X(t), skS4Y = polVS4Y(t), skDX = polVDX(t), skDY = polVDY(t);
const
    uskE2 = polE2(t), uskE4 = polE4(t),
    uskA = polAA(t), uskBAn = polABAn(t), uskBAt = polABAt(t), uskBA = polABA(t), uskB = polAB(t), uskS2 = polAS2(t),
    uskC = polAC(t), uskDCn = polADCn(t), uskDCt = polADCt(t), uskDC = polADC(t), uskD = polAD(t), uskS4 = polAS4(t),
    uskAX = polAAX(t), uskAY = polAAY(t), uskS2X = polAS2X(t), uskS2Y = polAS2Y(t), uskBX = polABX(t),
    uskBY = polABY(t),
    uskCX = polACX(t), uskCY = polACY(t), uskS4X = polAS4X(t), uskS4Y = polAS4Y(t), uskDX = polADX(t),
    uskDY = polADY(t);
...
const contentTag =
    ...
    pol2_1([
        ...
        polPostrSkTochkiKrivKor("postr_VC", "C", "O", "A", OC, OA, 90),
    ...
    pol2_3([
        ...
        polPostrUskTochkiKrivKor("postr_AC", "C", "O", "A", OC, OA, 90),
...
const
    ...
    risVS2 = elNaStr("sk_VS2"), risVC = elNaStr("sk_VC"), risVDC = elNaStr("sk_VDC"),
...
const
    ...
    risAS2 = elNaStr("usk_AS2"), risAC = elNaStr("usk_AC"), risADCN = elNaStr("usk_ADCN"),
...
zadPlNaStr(
    [skAX, skBX, skCX, skDX], [skAY, skBY, skCY, skDY], 500,
...
zadPlNaStr(
    [uskAX, uskBX, uskCX, uskDX, uskAX - uskBAn * Math.cos(FI2), uskCX - uskDCn * Math.cos(FI4)],
    [uskAY, uskBY, uskCY, uskDY, uskAY - uskBAn * Math.sin(FI2), uskCY - uskDCn * Math.sin(FI4)], 500,
    planUskRis, planUsk1, planUsk2, [
        ...
        [risADCT, uskCX - uskDCn * Math.cos(FI4), uskCY - uskDCn * Math.sin(FI4), uskDX, uskDY],
        [risADC, uskCX, uskCY, uskDX, uskDY],
...
postrKinDi(KOL, razmetka, TAKT, TOCH, per, sk, usk, polV, polA, skNakl, uskNakl, skGor, uskGor, osPer, osSk, osUsk, [
    [diPer1, polSBX, diSk1, polVBX, diUsk1, polABX, 0.25 * Pi], [diPer2, polSDX, diSk2, polVDX, diUsk2, polADX, 0.75 * Pi]
]);
