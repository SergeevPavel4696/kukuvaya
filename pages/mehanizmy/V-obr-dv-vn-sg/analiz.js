...
import {
    polTokAB, polTokAS2, polTokOA, polTokM1, polTokM2, polTokM3, polTokM4, polTokM5,
    polTokJs2, polTokJs4, polTokP5Max, polTokK, polTokTakt, polTokToch, polTokW,
    polTokP3Max, polTokJs1, polTokOC, polTokCS4, polTokCD, polTokD3, polTokD5
} from "./local_storage.js";
import {polP} from "../dv-chet-dv-vn-sg/analiz.js";
...
export function polFI2(t) {
    return Math.asin(-polSAY(t - 0.125 * polTokTakt()) / polTokAB()) + 0.25 * Pi;
}
...
export function polSB(t) {
    return polSBX(t) / Math.cos(0.25 * Pi);
}
...
export function polFI4(t) {
    return Math.acos(-polSCX(t - 0.125 * polTokTakt()) / polTokCD()) + 0.25 * Pi;
}
...
export function polSD(t) {
    return polSDX(t) / Math.cos(0.75 * Pi);
}

//Крайние положения механизма.
export function polLevKr() {
    return (polTokOC() + polTokCD()) * Math.cos(0.75 * Pi);
}

export function polVerhKr() {
    return polMax([(polTokOA() + polTokAB()) * Math.sin(0.25 * Pi), (polTokOC() + polTokCD()) * Math.sin(0.75 * Pi)]);
}

export function polPravKr() {
    return (polTokOA() + polTokAB()) * Math.cos(0.25 * Pi);
}
...
export function polNizh3() {
    return (-polTokOA() + polTokAB()) * Math.sin(0.25 * Pi);
}
...
export function polNizh5() {
    return (-polTokOC() + polTokCD()) * Math.sin(0.75 * Pi);
}
...
export function polVB(t) {
    return dif(polSB, t, polTokTakt()) / 1000;
}
...
export function polVD(t) {
    return dif(polSD, t, polTokTakt()) / 1000;
}
...
export function polP3(t) {
    ...
    return polP(polVBX(t), polLev3(), polSBX(t), polDiap3(), polP3Max(), t, takt, 0.25 * Pi);
}

export function polP3X(t) {
    return  polP3(t) * Math.cos(-0.75 * Pi);
}

export function polP3Y(t) {
    return  polP3(t) * Math.sin(-0.75 * Pi);
}

export function polP5(t) {
    return polP(polVDX(t), polPrav5(), polSDX(t), polDiap5(), polP5Max(), t + polTokTakt(), polTokTakt(), 0.75 * Pi);
}

export function polP5X(t) {
    return  polP5(t) * Math.cos(-0.25 * Pi);
}

export function polP5Y(t) {
    return  polP5(t) * Math.sin(-0.25 * Pi);
}

//Вторая группа Ассура.
export function polMomP5(t) {
    return polP5(t) * polTokCD() * Math.sin(polFI4(t) - 0.75 * Pi) / 1000;
}

export function polMomFIn5(t) {
    return (polFIn5X(t) * (polSCY(t) - polSDY(t)) - polFIn5Y(t) * (polSCX(t) - polSDX(t))) / 1000;
}
...
export function polMomG4(t) {
    return -polG4(t) * (polSCX(t) - polSS4X(t)) / 1000;
}

export function polMomR05(t) {
    return -polR05(t) * (polTokCD() * Math.cos(polFI4(t) - 0.75 * Pi) / 1000);
}

export function polPlA(t) {
    return polTokCD() * Math.cos(0.75 * Pi - polFI4(t)) / 1000;
}

export function polPlB(t) {
    return Math.abs(polTokCD() * Math.sin(0.75 * Pi - polFI4(t))) / 1000;
}
...
export function polR05(t) {
    return (polMomP5(t) + polMomFIn5(t) + polMomG5(t) + polMomFIn4(t) + polMomG4(t) + polMIn4(t)) /
        (polTokCD() * Math.cos(polFI4(t) - 0.75 * Pi) / 1000);
}

export function polR05X(t) {
    return polR05(t) * Math.cos(0.25 * Pi);
}

export function polR05Y(t) {
    return polR05(t) * Math.sin(0.25 * Pi);
}
...
export function polMomP3(t) {
    return polP3(t) * polTokAB() * Math.sin(polFI2(t) - 0.25 * Pi) / 1000;
}
...
export function polMomR03(t) {
    return -polR03(t) * polTokAB() * Math.cos(polFI2(t) - 0.25 * Pi) / 1000;
}

export function polPlF(t) {
    return polTokAB() * Math.cos(0.25 * Pi - polFI2(t)) / 1000;
}

export function polPlG(t) {
    return Math.abs(polTokAB() * Math.sin(0.25 * Pi - polFI2(t))) / 1000;
}
...
export function polMomUr(t) {
    return (polR41X(t) * polSCY(t) - polR41Y(t) * polSCX(t) + polR21X(t) * polSAY(t) - polR21Y(t) * polSAX(t)) / 1000;
}
...
export function polJp(t) {
    return polJpMeh([
        ...
        [polTokJs1(), polW1(t)], [polTokJs2(), polW2(t)], [polTokJs4(), polW4(t)]
    ], polW1(t));
}
...
export function polUgG5VD(t) {
    return (polVD(t) <= 0 ? 45 : 135);
}

export function polUgP3VB(t) {
    return (polVB(t) * polP3(t) >= 0 ? 0 : 180);
}

export function polUgP5VD(t) {
    return (polVD(t) * polP5(t) >= 0 ? 0 : 180);
}
...
export function polMpP3(t) {
    return polMpF(polP3(t), polVBX(t) / Math.cos(0.25 * Pi), Math.abs(polW1(t)));
}

export function polMpP5(t) {
    return polMpF(polP5(t), polVDX(t) / Math.cos(0.75 * Pi), Math.abs(polW1(t)));
}

export function polMp(t) {
    return polMpMeh([[polG2(true), polVS2Y(t)], [polG3(true), polVBY(t)], [polG4(true), polVS4Y(t)],
        [polG5(true), polVDY(t)], [polP3(t), polVBX(t) / Math.cos(0.25 * Pi)], [polP5(t), polVDX(t) / Math.cos(0.75 * Pi)]],
        Math.abs(polW1(t)));
}
...
export function polMdv() {
    return polMdvMeh(polTokToch(), polMp, 2 * polTokTakt());
}
...
export function polIzmEn1(t) {
    return polIzmEnMeh1(polTokK(), 2 * polTokTakt(), polMp, polMdv, polTokToch(), polTokW(), t);
}
