...
import {
    polAB, polAD, polAS2, polAS4, polE2, polE4, polFIn2, polFIn2X, polFIn2Y, polFIn3, polFIn3X, polFIn3Y, polFIn4,
...
const contentTag =
    pol3(diDavl, planSil2, planSil1, planSilNach, 3) +
...
zadPlNaStrZamk(
    ...
    [[risR05, R05X, R05Y, [{ob: "R45", ris: risR45, nach: false}], null], [risP5, P5X, P5Y], [risFI5, FIn5X, FIn5Y],
        [risG5, 0, G5, null, [{ob: "R45", ris: risR45, nach: true}]], [risFI4, FIn4X, FIn4Y], [risG4, 0, G4], [risR14, R14X, R14Y]]);

zadPlNaStrZamk(
    [R03X, P3X, FIn3X, FIn2X], [R03Y, P3Y, FIn3Y, G3, FIn2Y, G2], 500,
    planSil1Ris, planSil11, planSil12,
    [[risR03, R03X, R03Y, [{ob: "R23", ris: risR23, nach: false}]], [risP3, P3X, P3Y], [risFI3, FIn3X, FIn3Y],
        [risG3, 0, G3, null, [{ob: "R23", ris: risR23, nach: true}]], [risFI2, FIn2X, FIn2Y], [risG2, 0, G2], [risR12, R12X, R12Y]]);
