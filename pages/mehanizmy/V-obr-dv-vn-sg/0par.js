...
import {
    polFI1A, polFI1C, polFI2, polFI4, polLevKr, polNizhKr, polPravKr, polSAX, polSAY, polSB, polSBX,
    polSBY, polSCX, polSCY, polSD, polSDX, polSDY, polSS2X, polSS2Y, polSS4X, polSS4Y, polVerhKr, polMin5, polMin3
} from "./analiz.js";
import {zadPerEl, zadPerVrEl, zadVrEl} from "../../../scripts/utils-svg-geom.js";
import {
    polTokAB, polTokAS2, polTokCD, polTokCS4, polTokD3, polTokD5, polTokFi, polTokJs1, polTokJs2, polTokJs4, polTokK,
    polTokM1, polTokM2, polTokM3, polTokM4, polTokM5, polTokN1, polTokNerav, polTokOA, polTokOC,
    polTokP3Max, polTokP5Max, polTokToch, tokAB, tokAS2, tokCD, tokCS4, tokD3, tokD5, tokFi, tokJS1, tokJS2, tokJS4,
    tokK, tokM1, tokM2, tokM3, tokM4, tokM5, tokN1, tokNerav, tokOA, tokOC, tokP3Max, tokP5Max, tokToch
...
function zadRazmIzobr() {
    ...
    zadPerVrEl(st3, (polMin3() - 90) * Math.cos(0.25 * Pi), (polMin3() - 90) * Math.sin(0.25 * Pi), 45);
    zadPerVrEl(st5, (polMin5() - 90) * Math.cos(0.75 * Pi), (polMin5() - 90) * Math.sin(0.75 * Pi), 135);
    zadDlZv(tr3, polSB(t) - polMin3() + 90, 4);
    zadDlZv(tr5, polSD(t) - polMin5() + 90, 4);
}
...
function zadZv3Pol() {
    const t = polTekVr();
    zadPerVrEl(zv3, polSBX(t), polSBY(t), 45);
}
...
function zadZv5Pol() {
    const t = polTekVr();
    zadPerVrEl(zv5, polSDX(t), polSDY(t), 135);
}
