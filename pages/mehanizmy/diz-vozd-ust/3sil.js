import {diDavl, planSil2, planSil1, planSilNach} from "./ris.js";
import {
    polAB, polAC, polAS2, polAS4, polE2, polE4, polFIn2, polFIn2X, polFIn2Y, polFIn3, polFIn3X, polFIn3Y, polFIn4,
    polFIn4X, polFIn4Y, polFIn5, polFIn5X, polFIn5Y, polG1, polG2, polG3, polG4, polG5, polMIn2, polMIn4, polMomFIn2,
    polMomFIn3, polMomFIn4, polMomFIn5, polMomG2, polMomG3, polMomG4, polMomG5, polMomP3, polMomP5, polMomR03,
    polMomR05, polMomR21, polMomR41, polMomUr, polP3, polP3Max, polP3X, polP3Y, polP5, polP5Max, polP5X, polP5Y,
    polPlA, polPlB, polPlC, polPlD, polPlE, polPlF, polPlG, polPlH, polPlI, polPlJ, polPlK, polPlL, polR01,
    polR01X, polR01Y, polR03, polR03X, polR03Y, polR05, polR05X, polR05Y, polR12, polR12X, polR12Y, polR14,
...
import {
    polTekVr, polTokD3, polTokD5, polTokJs2, polTokJs4, polTokM1, polTokM2, polTokM3, polTokM4, polTokM5,
    polTokMuF1, polTokMuF2, polTokMuFNach, polTokP3Max, polTokP5Max, tokMuF1, tokMuF2, tokMuFNach
...
const p3max = polTokP3Max(), p5max = polTokP5Max(), f3max = polP3Max(), f5max = polP5Max();
const D3 = polTokD3(), D5 = polTokD5();
const uskE2 = polE2(t), uskE4 = polE4(t), uskS2 = polAS2(t), uskB = polAB(t), uskS4 = polAS4(t), uskC = polAC(t);
const
...
const
    R05 = polR05(t), R05X = polR05X(t), R05Y = polR05Y(t), R45 = polR45(t), R54 = polR54(t), P5 = polP5(t),
    P5X = polP5X(t), P5Y = polP5Y(t), FIn5 = polFIn5(t), FIn5X = polFIn5X(t), FIn5Y = polFIn5Y(t), G5 = polG5(true),
    FIn4 = polFIn4(t), FIn4X = polFIn4X(t), FIn4Y = polFIn4Y(t), G4 = polG4(true), R14 = polR14(t), R14X = polR14X(t),
    R14Y = polR14Y(t),
    R03 = polR03(t), R03X = polR03X(t), R03Y = polR03Y(t), R23 = polR23(t), R32 = polR32(t), P3 = polP3(t),
    P3X = polP3X(t), P3Y = polP3Y(t), FIn3 = polFIn3(t), FIn3X = polFIn3X(t), FIn3Y = polFIn3Y(t), G3 = polG3(true),
    FIn2 = polFIn2(t), FIn2X = polFIn2X(t), FIn2Y = polFIn2Y(t), G2 = polG2(true), R12 = polR12(t), R12X = polR12X(t),
    R12Y = polR12Y(t),
...
const
    plA = polPlA(t), plB = polPlB(t), plC = polPlC(t), plD = polPlD(t), plE = polPlE(t),
    plF = polPlF(t), plG = polPlG(t), plH = polPlH(t), plI = polPlI(t), plJ = polPlJ(t),
    plK = polPlK(t), plL = polPlL(t);

//Добавить разметку страницы.
const content = document.getElementById("content");
const contentTag =
    pol3(diDavl, planSil2, planSil1, planSilNach, 4) +
    pol3_1([[1, m1, g1], [2, m2, g2], [3, m3, g3], [4, m4, g4], [5, m5, g5]],
        [[2, 2, m2, uskS2, fin2], [3, "B", m3, uskB, fin3], [4, 4, m4, uskS4, fin4], [5, "C", m5, uskC, fin5]],
        [[2, js2, uskE2, min2], [4, js4, uskE4, min4]],
        [[3, p3max, D3, f3max], [5, p5max, D5, f5max]]) +
    pol3_2([
        polRasschReak([0, 5, "A"], [
    ...
    pol3_4([
        polRasschReak([0, 3, "A"], [
            [momR03, "R 03", "f", R03, plF],
            [momP3, "P 3", "g", P3, plG],
            [momFi3, "Φ 3", "g", FIn3, plG],
            [momG3, "G 3", "h", G3, plH],
            [momFi2, "Φ 2", "i", FIn2, plI],
            [momG2, "G 2", "j", G2, plJ]
        ], [[min2, 2]]),
    ...
    pol3_8([[momR41, "R 41", "k", R41, plK], [momR21, "R 21", "l", R21, plL]], momur);
...
zadPlNaStrZamk(
    [R05X, P5X, FIn5X, FIn4X], [R05Y, P5Y, FIn5Y, G5, FIn4Y, G4], 500,
    planSil2Ris, planSil21, planSil22,
    [[risR05, R05X, R05Y, [{ob: "R45", ris: risR45, nach: true}], null], [risP5, P5X, P5Y], [risFI5, FIn5X, FIn5Y], [risG5, 0, G5, null, [{ob: "R45", ris: risR45, nach: false}]],
        [risFI4, FIn4X, FIn4Y], [risG4, 0, G4], [risR14, R14X, R14Y]]);

zadPlNaStrZamk(
    [R03X, P3X, FIn3X, FIn2X], [R03Y, P3Y, FIn3Y, G3, FIn2Y, G2], 500,
    planSil1Ris, planSil11, planSil12,
    [[risR03, R03X, R03Y, [{ob: "R23", ris: risR23, nach: true}], null], [risP3, P3X, P3Y], [risFI3, FIn3X, FIn3Y], [risG3, 0, G3, null, [{ob: "R23", ris: risR23, nach: false}]],
