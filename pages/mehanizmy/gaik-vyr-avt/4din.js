...
import {
    polTokJs1, polTokJs2, polTokJs4, polTokK, polTokM2, polTokM3, polTokM4, polTokM5,
    polTokMuDE, polTokMuFI1, polTokMuFI2, polTokMuJP, polTokMuMP, polTokNerav, polTokOtrDe,
    polTekVr, tokMuDe, tokMuFi1, tokMuFi2, tokMuJp, tokMuMp, tokOtrDe, polTokJs3, polTokJsDv,
} from "./local_storage.js";
import {pol4Znach, pol4ZnachVek, polDMahSr, polJMah, zadPerVHran, zadPole} from "../utils.js";
import {
    polVS2, polVS4, polW1, polW2, polW4, polG2, polG4, polG3, polP5, polUgG2VS2, polUgG4VS4, polJp, polMp,
    polMpMass, polMdv, polUgPsi, polG5, polVS3, polVD, polUgG5VD, polUgG3VS3, polUgP5VD, polW3, polWDv
} from "./analiz.js";
...
const
    m2 = pol4Znach(polTokM2()), m3 = pol4Znach(polTokM3()), m4 = pol4Znach(polTokM4()),
    m5 = pol4Znach(polTokM5()), js1 = pol4Znach(polTokJs1()), js2 = pol4Znach(polTokJs2()),
    js3 = pol4Znach(polTokJs3()), js4 = pol4Znach(polTokJs4()),jsdv = pol4Znach(polTokJsDv());
//Скорости и угловые скорости звеньев.
const
    skS2 = pol4Znach(polVS2(t)), skS3 = pol4Znach(polVS3(t)), skS4 = pol4Znach(polVS4(t)),
    skD = pol4Znach(polVD(t)), skW1ch = polW1(t), skW1 = pol4Znach(skW1ch), skW2 = pol4Znach(polW2(t)),
...
const contentTag =
    pol4() +
    pol4_1(
        [[2, 2, m2, skS2], [3, 3, m3, skS3], [4, 4, m4, skS4], [5, "D", m5, skD]],
        [[1, 1, js1, skW1], [2, 2, js2, skW2], [3, 3, js3, skW3], [4, 4, js4, skW4], ["дв", "дв", jsdv, skWDv]],
        Jp, skW1) +
    pol4_2(
        [[2, 2, g2, skS2, g2vs2], [3, 3, g3, skS3, g3vs3], [4, 4, g4, skS4, g4vs4], [5, "D", g5, skD, g5vd]],
        [[5, "D", p5, skD, p5vd]],
        Mp, skW1) +
