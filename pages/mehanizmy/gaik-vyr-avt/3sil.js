...
import {
    polAD, polAS4, polE2, polE3, polE4, polFIn2, polFIn2X, polFIn2Y, polFIn4, polFIn4X, polFIn4Y, polFIn5, polG1,
    polG2, polG3, polG4, polG5, polMIn2, polMIn3, polMIn4, polMomFIn2, polMomFIn4, polMomG2, polMomG4, polMomP5,
    polMomR21, polMomUr, polP5, polPlA, polPlB, polPlC, polPlD, polPlF, polPlI, polPlH, polPlG, polPlE, polPlK,
    polR01, polR01X, polR01Y, polR03, polR12, polR21, polR21X, polR21Y, polR32, polR34, polR34X, polR34Y, polR43X,
    polR43Y, polR45, polR54, polR12T, polPlJ, polR12N, polR12TX, polR12TY, polR12NX, polR12NY, polMomFIn5, polMomG5,
    polMomR05, polFIn3, polAS2, polAS3, polMomR03t, polMomFIn3, polMomG3, polMomR12t, polR05, polFIn5X,
    polR03T, polR03TX, polR03TY, polR03N, polR03NX, polR03NY, polFIn3X, polFIn3Y, polR23
} from "./analiz.js";
...
const
    momR05 = polMomR05(t), momP5 = polMomP5(t), momFIn5 = polMomFIn5(t),
    momG5 = polMomG5(t), momFIn4 = polMomFIn4(t), momG4 = polMomG4(t),
...
const
    ...
    P5 = polP5(t), FIn5 = polFIn5X(t), FIn4 = polFIn4(t), FIn4X = polFIn4X(t), FIn4Y = polFIn4Y(t),
    ...
    FIn2 = polFIn2(t), FIn2X = polFIn2X(t), FIn2Y = polFIn2Y(t),
...
const contentTag =
    ...
    pol3_1([[1, m1, G1], [2, m2, G2], [3, m3, G3], [4, m4, G4], [5, m5, G5]],
        [[2, 2, m2, uskS2, fin2], [3, 3, m3, uskS3, fin3], [4, 4, m4, uskS4, fin4], [5, "D", m5, uskD, fin5]],
...
zadPlNaStrZamk(
    [P5, FIn5, FIn4X], [R05, G5, FIn4Y, G4], 500,
    planSil2Ris, planSil21, planSil22,
    [[risR05, 0, R05, [{ob: "R45", ris: risR45, nach: false}], null], [risP5, P5, 0],
        [risFI5, FIn5, 0], [risG5, 0, G5, null, [{ob: "R45", ris: risR45, nach: true}]],
