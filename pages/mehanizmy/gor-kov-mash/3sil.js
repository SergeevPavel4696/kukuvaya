...
import {
    polAB, polAD, polAS2, polAS4, polE2, polE4, polFIn2, polFIn2X, polFIn2Y, polFIn3, polFIn4, polFIn4X, polFIn4Y,
    polFIn5, polG1, polG2, polG3, polG4, polG5, polMIn2, polMIn4, polMomFIn2, polMomFIn3, polMomFIn4, polMomFIn5,
    polMomG2, polMomG3, polMomG4, polMomG5, polMomP3, polMomP5, polMomR03, polMomR05, polMomR21, polMomR43,
    polMomUr, polP3, polP5, polPlA, polPlB, polPlC, polPlD, polPlF, polPlG, polPlH, polPlI, polPlJ,
    polR01, polR03, polR05, polR12, polR21, polR21X, polR21Y, polR23, polR34, polR32, polR43, polR43X,
    polR43Y, polR45, polR54, polFIn5Y, polFIn3X, polR34X, polR34Y, polR12X, polR12Y, polR01X, polR01Y, polPlE
} from "./analiz.js";
...
const
    ...
    momG2 = polMomG2(t), momR43 = polMomR43(t),
...
const
    ...
    R34 = polR34(t), R34X = polR34X(t), R34Y = polR34Y(t),
    ...
    R43 = polR43(t), R43X = polR43X(t), R43Y = polR43Y(t), R12 = polR12(t), R12X = polR12X(t), R12Y = polR12Y(t),
...
const contentTag =
    ...
    pol3_4([
        ...
        polRasschReak([0, 3, "A"], [
            ...
            [momG3, "G 3", "e", G3, plE],
            [momFi2, "Φ 2", "h", FIn2, plH],
            [momG2, "G 2", "i", G2, plI]
        ], [[min2, 2]]),
        polPostrCepVekIzPol(["R 43", "R 03", "P 3", "Φ 3", "G 3", "Φ 2", "G 2"], "postr_cep1"),
        polZamkCep(1, 2, ["R 43", "R 03", "P 3", "Φ 3", "G 3", "Φ 2", "G 2"], "zamk_gr1"),
        polZamkCep2Zv1Vek(2, 3, ["Φ 2", "G 2", "R 12"], ["R 43", "R 03", "P 3", "Φ 3", "G 3"], "zamk_zv23", true)
    ]) +
    pol3_5([
        ["12", "plr12", "mur11", R12],
        ["23", "plr23", "mur12", R23],
...
const
    ...
    risR43 = elNaStr("sil_R43"), risR21 = elNaStr("sil_R21"), risG1 = elNaStr("sil_G1"), risR01 = elNaStr("sil_R01");
...
aktInterPu(planSil1Ris, [
    ["postr_cep1", [risR03, risP3, risFI3, risG3, risFI2, risG2, risR43]],
    ["vekR43", [risR43]],
    ["vekR03", [risR03]],
    ["vekP3", [risP3]],
    ["vekΦ3", [risFI3]],
...
zadPlNaStrZamk(
    [R43X, P3, FIn3X, FIn2X], [R43Y, R03, G3, FIn2Y, G2], 500,
    planSil1Ris, planSil11, planSil12,
    [[risR43, R43X, R43Y, [{ob: "R23", ris: risR23, nach: true}], null], [risR03, 0, R03], [risP3, P3, 0], [risFI3, FIn3X, 0], [risG3, 0, G3, null, [{ob: "R23", ris: risR23, nach: false}]],
