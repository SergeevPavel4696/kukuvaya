...
import {
    ...
    tokMuDe, tokMuFi1, tokMuFi2, tokMuJp, tokMuMp, tokOtrDe, polTokJsDv, polTokJs3, polTokTakt,
} from "./local_storage.js";
import {pol4Znach, pol4ZnachVek, polDMahSr, polJMah, zadPerVHran, zadPole} from "../utils.js";
import {
    polVS4, polW1, polW2, polW4, polG2, polG4, polP5, polUgG4VS4, polJp, polMp, polMpMass,
    polMdv, polUgPsi, polG5, polVD, polUgG5VD, polUgP5VD, polVA1, polW3, polUgG2VA1, polWDv, polVDY
} from "./analiz.js";
...
const
    skA1 = pol4Znach(polVA1(t)), skS4 = pol4Znach(polVS4(t)), skD = pol4Znach(polVD(t)),
...
const
    g2va1 = pol4Znach(polUgG2VA1(t)), g4vs4 = pol4Znach(polUgG4VS4(t)),
...
const contentTag =
    pol4() +
    pol4_1(
        [[2, "A" + WFInd1(1), m2, skA1], [4, 4, m4, skS4], [5, "D", m5, skD]],
        [[1, 1, js1, skW1], [2, 2, js2, skW2], [3, 3, js3, skW3], [4, 4, js4, skW4], ["дв", "дв", jsdv, skWDv]],
        Jp, skW1) +
    pol4_2(
        [[2, "A" + WFInd1(1), g2, skA1, g2va1], [4, 4, g4, skS4, g4vs4], [5, "D", g5, skD, g5vd]],
        [[5, "D", p5, skD, p5vd]],
        Mp, skW1) +
