...
import {
    ...
    polFIn5Y, polG1, polG2, polG3, polG4, polG5, polMIn2, polMIn3, polMIn4, polMomFIn2, polMomFIn4, polMomG2, polMomG4,
    polMomP5, polMomR21, polMomR43, polMomR45Y2Gor, polMomR45Vert, polMomR54X, polMomR54Y, polMomRY1Y2, polMomRY2Y1,
    polMomUr, polP5, polPlA, polPlB, polPlC, polPlD, polPlF, polPlI, polPlH, polPlG, polPlE, polPlK, polPlL, polPlM,
    polR01, polR01X, polR01Y, polR03, polR03X, polR03Y, polR12, polR21, polR21X, polR21Y, polR23,
    polR32, polR32X, polR32Y, polR34, polR34X, polR34Y, polR43, polR43X, polR43Y, polR45, polR45X,
    polR45Y, polR54, polR54X, polR54Y, polRY1, polRY2, polMomR45Y1Gor, polMomR12, polR12T, polPlJ, polPlN, polR12N,
    polR12TX, polR12TY, polR12NX, polR12NY
} from "./analiz.js";
...
const fin2 = polFIn2(t), fin4 = polFIn4(t), fin5 = polFIn5(t);
const min2 = polMIn2(t), min3 = polMIn3(t), min4 = polMIn4(t);
const uskE2 = polE2(t), uskE3 = polE3(t), uskE4 = polE4(t), uskA1 = polAA1(t), uskS4 = polAS4(t), uskD = polAD(t);
const
    momRY1 = polMomRY1Y2(t), momRY2 = polMomRY2Y1(t), momP5 = polMomP5(t), momR45Y1Gor = polMomR45Y1Gor(t),
    momR45Y2Gor = polMomR45Y2Gor(t), momR45Vert = polMomR45Vert(t), momR54X = polMomR54X(t), momR54Y = polMomR54Y(t),
    momFIn4 = polMomFIn4(t), momG4 = polMomG4(t),
    momR43 = polMomR43(t), momFIn2 = polMomFIn2(t), momG2 = polMomG2(t), momR12 = polMomR12(t),
    momR21 = polMomR21(t), momur = polMomUr(t);
const
    R54X = polR54X(t), R54Y = polR54Y(t), R54 = polR54(t), R45X = polR45X(t), R45Y = polR45Y(t), R45 = polR45(t),
    R34X = polR34X(t), R34Y = polR34Y(t), R34 = polR34(t), R05Y1 = polRY1(t), R05Y2 = polRY2(t),
    P5 = polP5(t), FIn5Y = polFIn5Y(t), G5 = polG5(true),
    FIn4 = polFIn4(t), FIn4X = polFIn4X(t), FIn4Y = polFIn4Y(t), G4 = polG4(true),
    R43X = polR43X(t), R43Y = polR43Y(t), R43 = polR43(t), R23 = polR23(t),
    R03X = polR03X(t), R03Y = polR03Y(t), R03 = polR03(t), R32X = polR32X(t), R32Y = polR32Y(t), R32 = polR32(t),
    R12 = polR12(t), R12T = polR12T(t), R12TX = polR12TX(t), R12TY = polR12TY(t),
    R12N = polR12N(t), R12NX = polR12NX(t), R12NY = polR12NY(t), G3 = polG3(true), FIn2 = polFIn2(t),
    FIn2X = polFIn2X(t), FIn2Y = polFIn2Y(t), G2 = polG2(true),
    R21X = polR21X(t), R21Y = polR21Y(t), R21 = polR21(t), G1 = polG1(true), R01 = polR01(t), R01X = polR01X(t),
    R01Y = polR01Y(t);
const
...
const contentTag =
    ...
    pol3_1([[1, m1, g1], [2, m2, g2], [3, m3, g3], [4, m4, g4], [5, m5, g5]],
        [[2, 2, m2, uskA1, fin2], [4, 4, m4, uskS4, fin4], [5, "D", m5, uskD, fin5]],
        [[2, js2, uskE2, min2], [3, js3, uskE3, min3], [4, js4, uskE4, min4]]) +
    pol3_2([
        polRasschGorVertReak([4, 5, "верт"], [
            [R45Y, "R 45 верт"],
            [P5, "P 5"],
            [FIn5Y, "Φ 5"],
            [G5, "G 5"]
        ]),
        polOprObrReak([[5, 4, "верт"]]),
        polRasschReak([5, 4, "C", "гор"], [
            [momR54X, "R 54 гор", "a", R54X, plA],
            [momR54Y, "R 54 верт", "b", R54Y, plB],
            [momFIn4, "Φ 4", "c", FIn4, plC],
            [momG4, "G 4", "d", G4, plD]
        ], [[min4, 4]], true),
        polOprObrReak([[4, 5, "гор"]]),
        polRasschReak([0, 5, "Y" + WFInd1(2), "Y" + WFInd1(1)], [
            [momRY1, "R 05 Y" + WFInd1(1), "e", R05Y1, plE],
            [momP5, "P 5", "f", P5, plF],
            [momR45Vert, "R 45 верт", "g", R45Y, plG],
            [momR45Y2Gor, "R 45 гор", "h", R45X, plH],
        ]),
        polRasschReak([0, 5, "Y" + WFInd1(1), "Y" + WFInd1(2)], [
            [momRY2, "R 05 Y" + WFInd1(2), "e", R05Y2, plE],
            [momP5, "P 5", "f", P5, plF],
            [momR45Vert, "R 45 верт", "g", R45Y, plG],
            [momR45Y1Gor, "R 45 гор", "i", R45X, plI],
        ]),
        polPostrCepVekIzPol(["R 05 Y1", "P 5", "Φ 5", "G 5", "R 05 Y2", "Φ 4", "G 4"], "postr_cep2"),
        polZamkCep(3, 4, ["R 05 Y1", "P 5", "Φ 5", "G 5", "R 05 Y2", "Φ 4", "G 4"], "zamk_gr2"),
        polZamkCep2Zv1Vek(4, 5, ["Φ 4", "G 4", "R 34"], ["R 05 Y1", "P 5", "Φ 5", "G 5", "R 05 Y2"], "zamk_zv45", true)
    ]) +
    pol3_3([
        ["34", "plr34", "mur21", R34],
        ["45", "plr45", "mur22", R45],
    ...
    pol3_4([
        ...
        polRasschReak([1, 2, "B", "τ"], [
            [momR12, "R 12 τ", "j", R12T, plJ],
            [momR43, "R 43", "k", R43, plK],
            [momFIn2, "Φ 2", "l", FIn2, plL],
            [momG2, "G 2", "m", G2, plM]
        ], [[min3, 3], [min2, 2]]),
        polPostrCepVekIzPol(["R 43", "G 3", "Φ 2", "G 2", "R 12 τ"], "postr_cep1"),
        polZamkCep1Zv2Vek(2, 1, 3, "12 n", "32", ["Φ 2", "G 2", "R 12 τ"], "zamk_zv2"),
        polOprObrReak([[2, 3]]),
        polZamkCep1Zv1Vek(0, 3, ["R 43", "G 3", "R 23"], "zamk_zv3"),
    ...
    pol3_8([[momR21, "R 21", "n", R21, plN]], momur);
...
const
    risR05Y1 = elNaStr("sil_R05Y1"), risR05Y2 = elNaStr("sil_R05Y2"), risP5 = elNaStr("sil_P5"),
    risFI5 = elNaStr("sil_FI5"), risG5 = elNaStr("sil_G5"), risFI4 = elNaStr("sil_FI4"),
    risG4 = elNaStr("sil_G4"), risR34 = elNaStr("sil_R34"), risR54 = elNaStr("sil_R54"),
    risR43 = elNaStr("sil_R43"), risR03 = elNaStr("sil_R03"), risG3 = elNaStr("sil_G3"),
    risFI2 = elNaStr("sil_FI2"), risG2 = elNaStr("sil_G2"), risR12 = elNaStr("sil_R12"),
    risR12T = elNaStr("sil_R12T"), risR12N = elNaStr("sil_R12N"), risR32 = elNaStr("sil_R32"),
...
aktInterPu(planSil2Ris, [
    ["postr_cep2", [risR05Y1, risP5, risFI5, risG5, risR05Y2, risFI4, risG4]],
    ["vekR05Y1", [risR05Y1]],
    ["vekP5", [risP5]],
    ["vekΦ5", [risFI5]],
    ["vekG5", [risG5]],
...
aktInterPu(planSil1Ris, [
    ["postr_cep1", [risR43, risG3, risFI2, risG2, risR12T]],
    ["vekR43", [risR43]],
    ["vekG3", [risG3]],
    ["vekΦ2", [risFI2]],
    ["vekG2", [risG2]],
...
zadPlNaStrZamk(
    [R05Y1, R05Y2, FIn4X], [P5, FIn5Y, G5, FIn4Y, G4], 500,
    planSil2Ris, planSil21, planSil22,
    [[risR05Y1, R05Y1, 0, [{ob: "R45", ris: risR54, nach: false}], null], [risP5, 0, P5],
        [risFI5, 0, FIn5Y], [risG5, 0, G5], [risR05Y2, R05Y2, 0, null, [{ob: "R45", ris: risR54, nach: true}]],
        [risFI4, FIn4X, FIn4Y], [risG4, 0, G4], [risR34, R34X, R34Y]]);

zadPlNaStrZamk(
    [R43X, FIn2X, R12TX, R12NX, R32X], [R43Y, G3, FIn2Y, G2, R12TY, R12NY, R32Y], 500,
    planSil1Ris, planSil11, planSil12,
    [[risR43, R43X, R43Y], [risG3, 0, G3], [risFI2, FIn2X, FIn2Y, [{ob: "R32", ris: risR32, nach: false}], null],
        [risG2, 0, G2], [risR12T, R12TX, R12TY, [{ob: "R12", ris: risR12, nach: true}], null],
        [risR12N, R12NX, R12NY, null, [{ob: "R32", ris: risR32, nach: true}, {ob: "R12", ris: risR12, nach: false}]], [risR03, R03X, R03Y]]
);
