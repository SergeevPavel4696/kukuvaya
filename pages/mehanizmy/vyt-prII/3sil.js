...
import {
    ...
    polG3, polG4, polG5, polMIn2, polMIn3, polMIn4, polMomFIn2, polMomFIn4, polMomG2, polMomG4, polMomP5, polMomR21,
    polMomUr, polP5, polPlA, polPlB, polPlC, polPlD, polPlF, polPlI, polPlH, polPlG, polPlE, polPlK, polR01, polR01X,
    polR01Y, polR03, polR12, polR21, polR21X, polR21Y, polR32, polR34, polR34X, polR34Y, polR43X, polR43Y, polR45,
    polR54, polR12T, polPlJ, polR12N, polR12TX, polR12TY, polR12NX, polR12NY, polMomFIn5, polMomG5, polMomR05, polAS2,
    polMomR03t, polMomG3, polMomR12t, polR05, polR03T, polR03TX, polR03TY, polR03N, polR03NX, polR03NY, polR23,
    polMomR43, polR43, polFIn5Y, polFIn3, polAS3, polAF, polMomFIn3, polPlL, polFIn3X, polFIn3Y
} from "./analiz.js";
...
const uskE2 = polE2(t), uskE3 = polE3(t), uskE4 = polE4(t), uskS2 = polAS2(t), uskS3 = polAS3(t), uskS4 = polAS4(t), uskF = polAF(t);
const
    momR05 = polMomR05(t), momP5 = polMomP5(t), momFIn5 = polMomFIn5(t), momG5 = polMomG5(t), momFIn4 = polMomFIn4(t),
    momG4 = polMomG4(t), momR43 = polMomR43(t), momR03 = polMomR03t(t), momFIn3 = polMomFIn3(t), momG3 = polMomG3(t),
    momR12 = polMomR12t(t), momFIn2 = polMomFIn2(t), momG2 = polMomG2(t), momR21 = polMomR21(t), momur = polMomUr(t);
const
    R05 = polR05(t), R45 = polR45(t), R54 = polR54(t), R34X = polR34X(t), R34Y = polR34Y(t), R34 = polR34(t),
    P5 = polP5(t), FIn5 = polFIn5Y(t), G5 = polG5(true), FIn4 = polFIn4(t), FIn4X = polFIn4X(t), FIn4Y = polFIn4Y(t),
    G4 = polG4(true), R43 = polR43(t), R43X = polR43X(t), R43Y = polR43Y(t), R03T = polR03T(t), R03TX = polR03TX(t),
    R03TY = polR03TY(t), R03N = polR03N(t), R03NX = polR03NX(t), R03NY = polR03NY(t), R03 = polR03(t),
    R12T = polR12T(t), R12TX = polR12TX(t), R12TY = polR12TY(t), R12N = polR12N(t), R12NX = polR12NX(t),
    R12NY = polR12NY(t), R12 = polR12(t), R32 = polR32(t), R23 = polR23(t), FIn3 = polFIn3(t),
    FIn3X = polFIn3X(t), FIn3Y = polFIn3Y(t), G3 = polG3(true), FIn2 = polFIn2(t),
    FIn2X = polFIn2X(t), FIn2Y = polFIn2Y(t), G2 = polG2(true), R21X = polR21X(t), R21Y = polR21Y(t), R21 = polR21(t),
    R01 = polR01(t), R01X = polR01X(t), R01Y = polR01Y(t), G1 = polG1(true);
const
...
const contentTag =
    ...
    pol3_1([[1, m1, g1], [2, m2, g2], [3, m3, g3], [4, m4, g4], [5, m5, g5]],
        [[2, 2, m2, uskS2, fin2], [3, 3, m3, uskS3, fin3], [4, 4, m4, uskS4, fin4], [5, "F", m5, uskF, fin5]],
    ...
    pol3_2([
        ...
        polZamkCep(3, 4, ["R 05", "P 5", "Φ 5", "G 5", "Φ 4", "G 4"], "zamk_gr2"),
        polZamkCep2Zv1Vek(4, 5, ["Φ 4", "G 4", "R 34"], ["R 05", "P 5", "Φ 5", "G 5"], "zamk_zv45", true)
    ]) +
    pol3_3([
        ["34", "plr34", "mur21", R34],
        ["45", "plr45", "mur22", R45],
    ...
    pol3_4([
        ...
        polRasschReak([0, 3, "B 3", "τ"], [
            ...
            [momR43, "R 43", "f", R43, plF],
            [momFIn3, "Φ 3", "g", FIn3, plG],
            [momG3, "G 3", "h", G3, plH]
        ], [[min3, 3]]),
        polRasschReak([1, 2, "B 2", "τ"], [
            [momR12, "R 12 τ", "i", R12T, plI],
            [momFIn2, "Φ 2", "j", FIn2, plJ],
            [momG2, "G 2", "k", G2, plK]
        ], [[min2, 2]]),
        polPostrCepVekIzPol(["R 03 τ", "R 43", "Φ 3", "G 3", "Φ 2", "G 2", "R 12 τ"], "postr_cep1"),
        polZamkCep2Zv2Vek("12 n", "03 n", ["R 03 τ", "R 43", "Φ 3", "G 3", "Φ 2", "G 2", "R 12 τ"], "zamk_gr1"),
        polPolnReak(0, 3, "zamk_zv03", true),
        polPolnReak(1, 2, "zamk_zv12"),
        polZamkCep2Zv1Vek(2, 3, ["Φ 2", "G 2", "R 12"], ["R 03", "R 43", "Φ 3", "G 3"], "zamk_zv23", true)
    ]) +
    pol3_5([
    ...
    pol3_8([[momR21, "R 21", "k", R21, plL]], momur);
...
const
    ...
    risFI4 = elNaStr("sil_FI4"), risG4 = elNaStr("sil_G4"), risR34 = elNaStr("sil_R34"), risR45 = elNaStr("sil_R45"),
...
aktInterPu(planSil1Ris, [
    ["postr_cep1", [risR03T, risR43, risFI3, risG3, risFI2, risG2, risR12T]],
    ["vekR03τ", [risR03T]],
    ["vekR43", [risR43]],
    ["vekΦ3", [risFI3]],
    ["vekG3", [risG3]],
...
function zadMKF2() {
    zadMuSil(2, muf2vvod.value, [["plr34", R34], ["plr45", R45], ["plr54", R54]]);
}

function zadMKF1() {
    zadMuSil(1, muf1vvod.value, [["plr12n", R12N], ["plr12", R12],
        ["plr03n", R03N], ["plr03", R03], ["plr23", R23], ["plr32", R32]]);
}
...
zadPlNaStrZamk(
    [R05, FIn4X], [P5, FIn5, G5, FIn4Y, G4], 500,
    planSil2Ris, planSil21, planSil22,
    [[risR05, R05, 0, [{ob: "R45", ris: risR45, nach: false}], null], [risP5, 0, P5],
        [risFI5, 0, FIn5], [risG5, 0, G5, null, [{ob: "R45", ris: risR45, nach: true}]],
        [risFI4, FIn4X, FIn4Y], [risG4, 0, G4], [risR34, R34X, R34Y]]);

zadPlNaStrZamk(
    [R03TX, R43X, FIn3X, FIn2X, R12TX, R12NX], [R03TY, R43Y, FIn3Y, G3, FIn2Y, G2, R12TY, R12NY], 500,
    planSil1Ris, planSil11, planSil12,
    [[risR03T, R03TX, R03TY, null, [{ob: "R03", ris: risR03, nach: false}]],
        [risR43, R43X, R43Y], [risFI3, FIn3X, FIn3Y], [risG3, 0, G3], [risFI2, FIn2X, FIn2Y, [{ob: "R32", ris: risR23, nach: false}], null],
