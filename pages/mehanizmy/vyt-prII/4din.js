...
import {
    polTokJs1, polTokJs2, polTokJs4, polTokK, polTokM2, polTokM3, polTokM4,
    polTokM5, polTokMuDE, polTokMuFI1, polTokMuFI2, polTokMuJP, polTokMuMP, polTokNerav,
    polTokOtrDe, polTekVr, tokMuDe, tokMuFi1, tokMuFi2, tokMuJp, tokMuMp, tokOtrDe, polTokJs3, polTokJsDv,
...
import {
    ...
    polVS3,
    polVF,
    polW3, polUgG3VS3, polUgG5VF, polUgP5VF, polWDv
} from "./analiz.js";
...
const
    ...
    skF = pol4Znach(polVF(t)), skW1ch = polW1(t), skW1 = pol4Znach(skW1ch), skW2 = pol4Znach(polW2(t)),
...
const
    ...
    g5vf = pol4Znach(polUgG5VF(t)), p5vf = pol4Znach(polUgP5VF(t));
...
const contentTag =
    pol4() +
    pol4_1(
        [[2, 2, m2, skS2], [3, 3, m3, skS3], [4, 4, m4, skS4], [5, "F", m5, skF]],
        [[1, 1, js1, skW1], [2, 2, js2, skW2], [3, 3, js3, skW3], [4, 4, js4, skW4], ["дв", "дв", jsdv, skWDv]],
        Jp, skW1) +
    pol4_2(
        [[2, 2, g2, skS2, g2vs2], [3, 3, g3, skS3, g3vs3], [4, 4, g4, skS4, g4vs4], [5, "F", g5, skF, g5vf]],
        [[5, "F", p5, skF, p5vf]],
        Mp, skW1) +
