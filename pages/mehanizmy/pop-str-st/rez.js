...
import {
    ...
    polR43,
    polR45X, polR45Y,
    polR54X, polR54Y, polRL1, polRL2, polSDX,
    polUgG2VA1, polUgG3VS3,
    polUgG4VS4,
    polUgG5VD,
    polUgP5VD,
...
let contentTag = polRez(TAKT, KOL,
    ...
    [["A1 ", polVA1], ["A3 A1", polVA3A1], ["A3 ", polVA3], ["C ", polVC],
        ["4 C", polVS4C], ["4 ", polVS4], ["D C", polVDC], ["D ", polVDX]],
    ...
    [[5, polP5]],
    [["05 L1", polRL1], ["05 L2", polRL2], ["45 гор", polR45X], ["45 верт", polR45Y], ["54 гор", polR54X],
    ...
    [polJp],
    [["G 2 A1", polUgG2VA1], ["G 3 3", polUgG3VS3], ["G 4 4", polUgG4VS4], ["G 5 D", polUgG5VD], ["P 5 D", polUgP5VD]],
