...
const mehRis = elNaStr("meh_ris"), st1 = elNaStr("st_1"), st3 = elNaStr("st_3"), st5 = elNaStr("st_5"),
    ...
    trS2S4 = elNaStr("tr_S2S4"), trB = elNaStr("tr_B"), trD = elNaStr("tr_D");
...
let planPolTag =
    ...
    polTagOpSk(null, 75, 90, OA + AB, false, false, null, null) +
    polTagOpSk(null, 75, 90, OC + CD, false, true, null, null);
for (let i = 0; i < KOL; i++) {
    const t = i * TAKT / KOL;
    planPolTag +=
...
zadRisRazm(planPol, null, 14 + polPravKr() - polLevKr(), 39 + polVerhKr() - polNizhKr())
