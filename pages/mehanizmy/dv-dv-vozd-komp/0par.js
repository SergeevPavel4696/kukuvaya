...
import {
    polFI1A, polFI2, polFI4, polSAX, polSAY, polPravKr, polSS2X, polSS2Y, polSS4X, polSS4Y,
    polLevKr, polVerhKr, polNizhKr, polSCY, polSCX, polFI1C, polNizh3, polNizh5, polSBY, polSDY
} from "./analiz.js";
import {
    polTokOA, polTokAB, polTokFi, polTokK, polTokM1, polTokM2, polTokM3, polTokM4, polTokM5,
    polTokJs1,polTokJs2, polTokJs4, polTokN1, polTokToch, tokOA, tokAB, tokFi, tokM1, tokM2,
    tokM3, tokM4, tokM5, tokJS1, tokJS2, tokJS4, tokK, tokN1, tokToch, polTokNerav, tokNerav,
    polTokOC, polTokCD, tokCD, tokOC, tokP3Max, tokP5Max, polTokP3Max, polTokP5Max, polTokAS2,
    polTokCS4, tokAS2, tokCS4, tokD3, tokD5, polTokD3, polTokD5, polTokJsDv, polTokNDv, tokJSDv, tokNDv
...
const
    ...
    n1_vvod = elNaStr("n1_vvod"), ndv_vvod = elNaStr("ndv_vvod"), m1_vvod = elNaStr("m1_vvod"), m2_vvod = elNaStr("m2_vvod"),
    ...
    jsdv_vvod = elNaStr("jsdv_vvod"), p3max_vvod = elNaStr("p3_vvod"), p5max_vvod = elNaStr("p5_vvod"), kol_vvod = elNaStr("kol_vvod"),
...
function zadRazmIzobr() {
    const t = polTekVr();
    zadRisRazm(meh, meh1, 14 + (polPravKr() - polLevKr()), 39 + (polVerhKr() - polNizhKr()), 7 - polLevKr(), 32 + polVerhKr());
    zadPerVrEl(st3, 2, polNizh3() - 90, 90);
    zadPerVrEl(st5, -2, polNizh5() - 90, 90);
    zadDlZv(tr3, polSBY(t) - polNizh3() + 90, 4);
    zadDlZv(tr5, polSDY(t) - polNizh5() + 90, 4);
}
