...
import {
    polTokOA, polTokAB, polTokAS2, polTokAD, polTokAS4, polTokW, polTokM1, polTokM2, polTokM3, polTokM4, polTokM5,
    polTokJs1, polTokJs2, polTokJs4, polTokJsDv, polTokTakt, polTokP3Max, polTokP5Max, polTokWDv, polTokK, polTokToch
...
export function polFI4(t) {
    return Math.acos(polSAX(t) / polTokAD()) - Pi;
}
...
export function polSDY(t) {
    return polSAY(t) + polTokAD() * Math.sin(polFI4(t));
}
...
export function polVDA(t) {
    return Math.abs(polW4(t) * polTokAD() / 1000);
}
...
export function polAS4An(t) {
    return Math.pow(polW4(t), 2) * polTokAS4() / 1000;
}

export function polAS4At(t) {
    return Math.abs(polE4(t) * polTokAS4() / 1000);
}

export function polAS4A(t) {
    return polGip(polAS4An(t), polAS4At(t));
}
...
export function polADAn(t) {
    return Math.pow(polW4(t), 2) * polTokAD() / 1000;
}

export function polADAt(t) {
    return Math.abs(polE4(t) * polTokAD() / 1000);
}

export function polADA(t) {
    return polGip(polADAn(t), polADAt(t));
}
...
export function polP3(t) {
    return (polVBY(t) >= 0 ? -polTokP3Max() * (polSBY(t) - polNizh3()) / polDiap() : 0)
}

export function polP5(t) {
    return (polVDY(t) <= 0 ? -polTokP5Max() * (polSDY(t) - polVerh5()) / polDiap() : 0)
}

//Вторая группа Ассура.
export function polMomP5(t) {
    return -polP5(t) * (polSAX(t) - polSDX(t)) / 1000;
}

export function polMomFIn5(t) {
    return -polFIn5Y(t) * (polSAX(t) - polSDX(t)) / 1000;
}

export function polMomG5(t) {
    return -polG5(true) * (polSAX(t) - polSDX(t)) / 1000;
}
...
export function polMomR05(t) {
    return polR05(t) * (polSAY(t) - polSDY(t)) / 1000;
}

export function polPlA(t) {
    return (polSAY(t) - polSDY(t)) / 1000;
}
