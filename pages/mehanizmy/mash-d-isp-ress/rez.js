...
import {
    ...
    polW2,
    polW4,
    polJpJsDv, polVDA, polVS4A, polADAn, polADAt, polADA, polAS4A, polSDY
} from "./analiz.js";
...
let contentTag = polRez(TAKT, KOL,
    ...
    [["A ", polVA], ["2 A", polVS2A], ["2 ", polVS2], ["B A", polVBA], ["B ", polVB],
        ["4 A", polVS4A], ["4 ", polVS4], ["D A", polVDA], ["D ", polVD]],
    [[1, polE1], [2, polE2], [4, polE4]],
    [["A ", polAA], ["2 A", polAS2A], ["2 ", polAS2], ["B A n", polABAn], ["B A τ", polABAt], ["B A", polABA],
        ["B ", polAB], ["4 A", polAS4A], ["4 ", polAS4], ["D A n", polADAn], ["D A τ", polADAt], ["D A", polADA], ["D ", polAD]],
