...
import {
    polTokJs1, polTokJs2, polTokJs4, polTokK, polTokM2, polTokM3, polTokM4, polTokM5, polTokMuDE,
    polTokMuFI1, polTokMuFI2, polTokMuJP, polTokMuMP, polTokNerav, polTokOtrDe, polTekVr, tokMuDe,
    tokMuFi1, tokMuFi2, tokMuJp, tokMuMp, tokOtrDe, polTokJsDv, polTokWDv, polTokJs3, polTokMMat,
...
const
    ...
    mmat = pol4Znach(polTokMMat()), js1 = pol4Znach(polTokJs1()), js2 = pol4Znach(polTokJs2()),
...
const contentTag =
    pol4() +
    pol4_1(
        [[2, 2, m2, skS2], [3, 3, m3, skS3], [4, 4, m4, skS4], [5, "D", m5, skD], ["мат", "D", mmat, skD]],
        [[1, 1, js1, skW1], [2, 2, js2, skW2], [3, 3, js3, skW3], [4, 4, js4, skW4], ["дв", "дв", jsdv, skWDv]],
        Jp, skW1) +
    pol4_2(
        [[2, 2, g2, skS2, g2vs2], [3, 3, g3, skS3, g3vs3], [4, 4, g4, skS4, g4vs4], [5, "D", g5, skD, g5vd], ["мат", "D", gmat, skD, gmatvd]],
        [[5, "D", p5, skD, p5vd]],
        Mp, skW1) +
