...
import {
    polFI1, polFI2, polFI4, polLev3, polLevKr, polNizhKr, polPravKr, polSAX, polSAY,
    polSBX, polSCX, polSCY, polSDY, polSS2X, polSS2Y, polSS4X, polSS4Y, polVerh5, polVerhKr
} from "./analiz.js";
import {
    polTokOA,
    polTokAB,
    ...
    tokCS4,
    polTokAC,
    tokAC, polTokNDv, polTokJsDv, tokNDv, tokJSDv,
...
contentTag += pol0par([
    ...
    ["ndv_vvod", "n<sub>дв1</sub>, об/мин", 0],
...
const
    ...
    a_vvod = elNaStr("a_vvod"), fi_vvod = elNaStr("fi_vvod"), n1_vvod = elNaStr("n1_vvod"),
    ...
    jsdv_vvod = elNaStr("jsdv_vvod"), p3max_vvod = elNaStr("p3max_vvod"), p5_vvod = elNaStr("p5_vvod"),
    kol_vvod = elNaStr("kol_vvod"), toch_vvod = elNaStr("toch_vvod"), nerav_vvod = elNaStr("nerav_vvod");
//Элементы механизма на рисунке.
const
    meh = elNaStr("meh_ris"), meh1 = elNaStr("meh_ris-1"), zv1 = elNaStr("zv1_ris"), zv2C = elNaStr("zv2C_ris"),
    zv2B = elNaStr("zv2B_ris"), zv3 = elNaStr("zv3_ris"), zv4 = elNaStr("zv4_ris"), zv5 = elNaStr("zv5_ris"),
...
function zadRazmIzobr() {
    const t = polTekVr();
    zadRisRazm(meh, meh1, 39 + (polPravKr() - polLevKr()), 39 + (polVerhKr() - polNizhKr()), 7 - polLevKr(), 7 + polVerhKr());
    zadPerEl(st3, polLev3() - 90, null);
    zadDlZv(tr3, polSBX(t) - polLev3() + 90, 4);
    zadPerVrEl(st5, polTokA(), polVerh5() - 90, -90);
    zadDlZv(tr5, polVerh5() - polSDY(t) - 90, 4);
}
...
function zadZv2Pol() {
    const t = polTekVr();
    zadPerVrEl(zv2C, polSAX(t), polSAY(t), polUgGrad(polFI2(t)));
    zadPerVrEl(zv2B, polSCX(t), polSCY(t), polUgGrad(polFI2(t)));
...
elFocusByPole(ab_vvod, zv2C);
elFocusByPole(ab_vvod, zv2B);
elFocusByPole(ac_vvod, shA);
elFocusByPole(ac_vvod, shC);
...
momInFocus(js2_vvod, [zv2C, zv2B], s2);
...
zadDlZv(zv2B, polTokAB() - polTokAC(), 1);
...
ab_vvod.addEventListener("input", function () {
    ...
    zadZv4Pol();
    zadZv5Pol();
    zadDlZv(zv2B, ab_vvod.value - ac_vvod.value, 1);
    zadOgrOA();
    zadOgrCD();
    zadOgrA();
});
...
a_vvod.addEventListener("input", function () {
    ...
    zadZv4Pol();
    zadZv5Pol();
    zadPerVrEl(st5, a_vvod.value, polVerh5() - 90, -90);
    zadOgrOA();
    zadOgrAB();
    zadOgrCD();
});
