...
import {
    polFI1, polFI2, polFI3B, polFI3D, polFI4, polLevKr, polNizh5, polNizhKr, polPravKr, polSAX, polSAY,
    polSBX, polSBY, polSDX, polSDY, polSEY, polSS2X, polSS2Y, polSS4X, polSS4Y, polVerh5, polVerhKr
} from "./analiz.js";
import {
    polTokA, polTokAB, polTokAS2, polTokB, polTokBC, polTokCD, polTokDE, polTokDS4, polTokFi, polTokP5Max,
    ...
    tokDE, tokDS4, tokFi, tokP5Max, tokJS1, tokJS2, tokJS3, tokJS4, tokJSDv, tokK, tokM1, tokM2, tokM3, tokM4,
    tokM5, tokN1, tokNDv, tokNerav, tokOA, tokToch, zadTokFi0
...
const
    ...
    bc_vvod = elNaStr("bc_vvod"), cd_vvod = elNaStr("cd_vvod"), de_vvod = elNaStr("de_vvod"),
    ds4_vvod = elNaStr("ds4_vvod"), a_vvod = elNaStr("a_vvod"), b_vvod = elNaStr("b_vvod"),
...
const
    ...
    shD = elNaStr("shD_ris"), shE = elNaStr("shE_ris"), s2 = elNaStr("s2_ris"), s4 = elNaStr("s4_ris"),
...
function zadRazmIzobr() {
    zadTokFi0();
    const t = polTekVr();
    zadRisRazm(meh, meh1, 14 + polPravKr() - polLevKr(), 39 + polVerhKr() - polNizhKr(), 7 - polLevKr(), 7 + polVerhKr());
    zadPerVrEl(st3, -a_vvod.value, b_vvod.value, 270);
    zadPerVrEl(st5, -a_vvod.value, polVerh5() + 90, 270);
    zadDlZv(tr5, -polSEY(t) + polVerh5() + 90, 4);
}
...
function zadZv3Pol() {
    const t = polTekVr();
    zadPerVrEl(zv3B, -polTokA(), polTokB(), polUgGrad(polFI3B(t)));
    zadPerVrEl(zv3D, -polTokA(), polTokB(), polUgGrad(polFI3D(t)));
...
function zadZv5Pol() {
    const t = polTekVr();
    zadPerVrEl(zv5, -polTokA(), polSEY(t), 90);
}
...
poleFocusByEl(zv4, de_vvod);
poleFocusByEl(shO, m1_vvod);
poleFocusByEl(s2, m2_vvod);
poleFocusByEl(shC, m3_vvod);
...
zadDlZv(zv3D, polTokCD(), 1);
zadDlZv(zv4, polTokDE(), 1);
...
de_vvod.addEventListener("input", function () {
    zadPerVHran(tokDE, de_vvod.value);
    zadRazmIzobr();
    zadZv1Pol();
    zadZv2Pol();
    zadZv3Pol();
