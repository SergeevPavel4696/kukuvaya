...
import {
    polAS4, polE2, polE3, polE4, polFIn2, polFIn2X, polFIn2Y, polFIn4, polFIn4X, polFIn4Y, polFIn5, polG1,
    polG2, polG3, polG4, polG5, polMIn2, polMIn3, polMIn4, polMomFIn2, polMomFIn4, polMomG2, polMomG4,
    ...
    polR12NX, polR12NY, polMomFIn5, polMomG5, polMomR05, polAS2, polMomR03t, polMomG3, polMomR12t, polR05,
    polR03T, polR03TX, polR03TY, polR03N, polR03NX, polR03NY, polR23, polAE, polMomR43, polR43, polFIn5Y
} from "./analiz.js";
...
const uskE2 = polE2(t), uskE3 = polE3(t), uskE4 = polE4(t), uskS2 = polAS2(t), uskS4 = polAS4(t), uskE = polAE(t);
const
    momR05 = polMomR05(t), momP5 = polMomP5(t), momFIn5 = polMomFIn5(t), momG5 = polMomG5(t), momFIn4 = polMomFIn4(t),
    momG4 = polMomG4(t), momR43 = polMomR43(t), momR03 = polMomR03t(t), momG3 = polMomG3(t), momR12 = polMomR12t(t),
    momFIn2 = polMomFIn2(t), momG2 = polMomG2(t), momR21 = polMomR21(t), momur = polMomUr(t);
const
    ...
    R12NY = polR12NY(t), R12 = polR12(t), R32 = polR32(t), R23 = polR23(t), G3 = polG3(true), FIn2 = polFIn2(t),
...
const contentTag =
    ...
    pol3_1([[1, m1, g1], [2, m2, g2], [3, m3, g3], [4, m4, g4], [5, m5, g5]],
        [[2, 2, m2, uskS2, fin2], [4, 4, m4, uskS4, fin4], [5, "E", m5, uskE, fin5]],
    ...
    pol3_4([
        ...
        polPostrCepVekIzPol(["R 03 τ", "R 43", "G 3", "Φ 2", "G 2", "R 12 τ"], "postr_cep1"),
        polZamkCep2Zv2Vek("12 n", "03 n", ["R 03 τ", "R 43", "G 3", "Φ 2", "G 2", "R 12 τ"], "zamk_gr1"),
        polPolnReak(0, 3, "zamk_zv03", true),
        polPolnReak(1, 2, "zamk_zv12"),
        polZamkCep2Zv1Vek(2, 3, ["Φ 2", "G 2", "R 12"], ["R 03", "R 43", "G 3"], "zamk_zv23", true)
    ]) +
    pol3_5([
...
const
    ...
    risFI4 = elNaStr("sil_FI4"),
    risG4 = elNaStr("sil_G4"), risR34 = elNaStr("sil_R34"), risR45 = elNaStr("sil_R45"),
    risR03T = elNaStr("sil_R03T"), risG3 = elNaStr("sil_G3"), risR43 = elNaStr("sil_R43"),
...
aktInterPu(planSil1Ris, [
    ["postr_cep1", [risR03T, risR43, risG3, risFI2, risG2, risR12T]],
    ["vekR03τ", [risR03T]],
    ["vekR43", [risR43]],
    ["vekG3", [risG3]],
    ["vekΦ2", [risFI2]],
...
zadPlNaStrZamk(
    [R03TX, R43X, FIn2X, R12TX, R12NX], [R03TY, G3, R43Y, FIn2Y, G2, R12TY, R12NY], 500,
    planSil1Ris, planSil11, planSil12,
    [[risR03T, R03TX, R03TY, null, [{ob: "R03", ris: risR03, nach: false}]],
        [risR43, R43X, R43Y], [risG3, 0, G3], [risFI2, FIn2X, FIn2Y, [{ob: "R32", ris: risR23, nach: false}], null],
