...
import {
    polFI1, polFI2, polFI4, polLev5, polLevKr, polNizh3, polNizhKr, polPrav5, polPravKr, polSAX, polSAY, polSBY,
...
import {
    polTokA, polTokAB, polTokAC, polTokAS2, polTokCD, polTokCS4, polTokFi, polTokJs1, polTokJs2,
    polTokJs4, polTokJsDv, polTokK, polTokM1, polTokM2, polTokM3, polTokM4, polTokM5, polTokN1,
    polTokNDv, polTokNerav, polTokOA, polTokP3Max, polTokP5Max, polTokToch, tokA, tokAB, tokAC,
    tokAS2, tokCD, tokCS4, tokFi, tokJS1, tokJS2, tokJS4, tokJSDv, tokK, tokM1, tokM2, tokM3,
...
const
    ...
    jsdv_vvod = elNaStr("jsdv_vvod"), p3_vvod = elNaStr("p3_vvod"), p5_vvod = elNaStr("p5_vvod"),
...
function zadRazmIzobr() {
    ...
    zadPerEl(st5, polLev5() - 90, -a_vvod.value);
...
momInFocus(js2_vvod, [zv2B, zv2C], s2);
