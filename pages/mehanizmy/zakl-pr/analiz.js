...
import {
    polTokAB, polTokAC, polTokAS2, polTokCD, polTokCS4, polTokOA, polTokTakt, polTokW,
    polTokM1, polTokM2, polTokM3, polTokM4, polTokM5, polTokJs2, polTokJs4, polTokJs1,
    polTokJsDv, polTokWDv, polTokP5Max, polTokP3Max, polTokA, polTokK, polTokToch
...
export function polSCX(t) {
    return polSAX(t) - polTokAC() * Math.cos(polFI2(t));
}

export function polSCY(t) {
    return polSAY(t) - polTokAC() * Math.sin(polFI2(t));
}

export function polFI4(t) {
    return Math.asin((-polTokA() - polSCY(t)) / polTokCD());
}
...
export function polLevKr() {
    return -polTokOA() * (polTokAB() + polTokAC()) / polTokAB();
}
...
export function polPravKr() {
    return polTokOA() * (polTokAB() + polTokAC()) / polTokAB() + polTokCD();
}

export function polNizhKr() {
    return -polMax([polTokA(), polTokOA() + polTokAC()]);
}
...
export function polVCA(t) {
    return Math.abs(polW2(t) * polTokAC() / 1000);
}
...
export function polACAn(t) {
    return Math.pow(polW2(t), 2) * polTokAC() / 1000;
}

export function polACAt(t) {
    return Math.abs(polE2(t) * polTokAC() / 1000);
}
...
export function polP3(t) {
    ...
    const S = polSBY(t);
    if (polVBY(t) >= 0) {
        return ((S < min + 0.6 * diap) ? (-P * (S - min) / (0.6 * diap)) : - P);
    } else {
        return 0;
    }
}
...
export function polP5(t) {
    return (polVDX(t) >= 0 ? -polTokP5Max() : 0);
}
...
export function polR24X(t) {
    return -polR54X(t) - polFIn4X(t);
}

export function polR24Y(t) {
    return -polR54Y(t) - polFIn4Y(t) - polG4(true);
}

export function polR24(t) {
    return polGip(polR24X(t), polR24Y(t));
}

//Первая группа Ассура.
export function polR42X(t) {
    return -polR24X(t);
}

export function polR42Y(t) {
    return -polR24Y(t);
}

export function polR42(t) {
    return polGip(polR42X(t), polR42Y(t));
}
...
export function polMomR42(t) {
    return (polR42X(t) * (polSAY(t) - polSCY(t)) - polR42Y(t) * (polSAX(t) - polSCX(t))) / 1000;
}

export function polPlE(t) {
    return polPlecho(polR42X(t), polR42Y(t), polSAX(t) - polSCX(t), polSAY(t) - polSCY(t)) / 1000;
}
...
export function polR03(t) {
    return -(polMomR42(t) + polMomP3(t) + polMomFIn3(t) + polMomG3(t) + polMomFIn2(t) + polMomG2(t) + polMIn2(t)) /
...
export function polR12X(t) {
    return -polR42X(t) - polR32X(t) - polFIn2X(t);
}

export function polR12Y(t) {
    return -polR42Y(t) - polR32Y(t) - polFIn2Y(t) - polG2(true);
}
...
export function polJpJsDv(t) {
    return polJpZv(polTokJsDv(), polTokWDv(), polW1(t));
}

export function polJp(t) {
    return polJpMeh([
        [polTokM2(), polVS2(t)], [polTokM3(), polVB(t)], [polTokM4(), polVS4(t)], [polTokM5(), polVD(t)],
        [polTokJs1(), polW1(t)], [polTokJs2(), polW2(t)], [polTokJs4(), polW4(t)], [polTokJsDv(), polTokWDv(t)]
    ], polW1(t));
}
...
export function polMp(t) {
    return polMpMeh([[polG2(true), polVS2Y(t)], [polG3(true), polVBY(t)],
        [polG4(true), polVS4Y(t)], [polP3(t), polVBY(t)], [polP5(t), polVDX(t)]], Math.abs(polW1(t)));
}
