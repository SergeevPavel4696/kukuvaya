...
import {
    ...
    polAD, polADC, polADCn, polADCt, polADX, polAS2, polAS2X, polAS2Y, polAS4, polAS4X, polAS4Y, polE2,
    polE4, polFI2, polFI4, polSBY, polSDX, polVA, polVAX, polVAY, polVB, polVBA, polVBY, polVC, polVCX,
    polVCY, polVD, polVDC, polVDX, polVS2, polVS2X, polVS2Y, polVS4, polVS4X, polVS4Y, polW2, polW4
} from "./analiz.js";
...
const
    ...
    uskBA = polABA(t), uskB = polAB(t), uskS2 = polAS2(t), uskC = polAC(t),
...
const contentTag =
    ...
    pol2_3([
        ...
        polPostrUskTochkiZvena("postr_ACAAC", "B", "A", "C", AC, AB, true),
