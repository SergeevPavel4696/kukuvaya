...
const
    ...
    G3 = polG3(true), FIn2 = polFIn2(t), FIn2X = polFIn2X(t), FIn2Y = polFIn2Y(t), G2 = polG2(true), R42 = polR42(t),
    R42X = polR42X(t), R42Y = polR42Y(t), R12 = polR12(t), R12X = polR12X(t), R12Y = polR12Y(t),
...
const
    ...
    plF = polPlF(t), plG = polPlG(t), plH = polPlH(t), plI = polPlI(t),
    plJ = polPlJ(t);
...
zadPlNaStrZamk(
    [R03, FIn2X, R42X], [P3, FIn3Y, G3, FIn2Y, G2, R42Y], 500,
