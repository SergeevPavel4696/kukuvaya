...
import {
    polAA, polAAX, polAAY, polAB, polABA, polABAn, polABAt, polABX, polAC, polACX, polACY, polAD, polADC,
    polADCn, polADCt, polADX, polAS2, polAS2X, polAS2Y, polAS4, polAS4X, polAS4Y, polE2, polE4, polFI2,
    polFI4, polSBX, polSDX, polVA, polVAX, polVAY, polVB, polVBA, polVBX, polVC, polVCX, polVCY, polVD,
...
const
    ...
    skS2 = polVS2(t), skC = polVC(t), skDC = polVDC(t), skD = polVD(t), skS4 = polVS4(t),
...
zadPlNaStr(
    [skAX, skBX, skCX, skDX], [skAY, skCY], 500,
...
zadPlNaStr(
    ...
    [uskAY, uskCY, uskAY - uskBAn * Math.sin(FI2), uskCY - uskDCn * Math.sin(FI4)], 500,
...
postrKinDi(KOL, razmetka, TAKT, TOCH, per, sk, usk, polV, polA, skNakl, uskNakl, skGor, uskGor, osPer, osSk, osUsk, [
    [diPer1, polSBX, diSk1, polVBX, diUsk1, polABX, 0], [diPer2, polSDX, diSk2, polVDX, diUsk2, polADX, 0]
]);
