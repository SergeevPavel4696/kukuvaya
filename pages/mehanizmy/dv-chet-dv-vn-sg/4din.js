...
import {
    ...
    polTokOtrDe, polTekVr, tokMuDe, tokMuFi1, tokMuFi2, tokMuJp, tokMuMp, tokOtrDe,
...
const
    skS2 = pol4Znach(polVS2(t)), skB = pol4Znach(polVB(t)), skS4 = pol4Znach(polVS4(t)), skD = pol4Znach(polVD(t)),
    skW1ch = polW1(t), skW1 = pol4Znach(skW1ch), skW2 = pol4Znach(polW2(t)), skW4 = pol4Znach(polW4(t));
...
const contentTag =
    ...
    pol4_1(
        ...
        [[1, 1, js1, skW1], [2, 2, js2, skW2], [4, 4, js4, skW4]],
        Jp, skW1) +
    pol4_2(
