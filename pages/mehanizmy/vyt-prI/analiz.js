...
import {
    ...
    polTokJsDv, polTokWDv, polTokP5Max, polTokP3Max, polTokK, polTokToch
...
export function polFI4(t) {
    return Math.asin(polSCY(t) / polTokCD()) + Pi;
}
...
export function polLevKr() {
    return -polTokOA() - polTokAC() - polTokCD();
}
...
export function polJp(t) {
    return polJpMeh([
        ...
        [polTokJs1(), polW1(t)], [polTokJs2(), polW2(t)], [polTokJs4(), polW4(t)], [polTokJsDv(), polTokWDv()]
    ], polW1(t));
}
...
export function polMp(t) {
    return polMpMeh([[polG2(true), polVS2Y(t)], [polG4(true), polVS4Y(t)],
            [polP3(t), polVBX(t)], [polP5(t), polVDX(t)]], Math.abs(polW1(t)));
}
