...
import {polTekVr, polTokAB, polTokAC, polTokCD, polTokK, polTokOA, polTokTakt, polTokToch} from "./local_storage.js";
...
let planPolTag =
    ...
    polTagOpSk(50, null, null, OA + AB, false, 0, null, null) +
    polTagOpSk(-50, null, 180, OA + AC + CD, false, 1, null, null);
for (let i = 0; i < KOL; i++) {
    const t = i * TAKT / KOL;
    planPolTag +=
...
zadRisRazm(planPol, null, 64 + polPravKr() - polLevKr(), 14 + polVerhKr() - polNizhKr(), 0, 0);
