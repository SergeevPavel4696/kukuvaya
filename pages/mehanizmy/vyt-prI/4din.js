...
import {
    ...
    polTokOtrDe, polTekVr, tokMuDe, tokMuFi1, tokMuFi2, tokMuJp, tokMuMp, tokOtrDe, polTokJsDv,
...
const
    ...
    js1 = pol4Znach(polTokJs1()), js2 = pol4Znach(polTokJs2()), js4 = pol4Znach(polTokJs4()), jsdv = pol4Znach(polTokJsDv());
...
const
    ...
    skW2 = pol4Znach(polW2(t)), skW4 = pol4Znach(polW4(t)), skWDv = pol4Znach(polWDv(t));
