...
import {
    polTokOA, polTokAB, polTokAS2, polTokOC, polTokCD, polTokCS4, polTokJs1,
    polTokJs2, polTokJs4, polTokK, polTokM1, polTokM2, polTokM3, polTokM4, polTokM5,
    polTokP3Max, polTokP5Max, polTokTakt, polTokToch, polTokW, polTokD3, polTokD5
...
export function polP3(t) {
    ...
    return polP(polVBY(t), polNizh3(), polSBY(t), polDiap3(), -polP3Max(), t, takt, 0);
}

export function polP5(t) {
    const takt = polTokTakt();
    return polP(polVDY(t), polNizh5(), polSDY(t), polDiap5(), -polP5Max(), t + 0.5 * takt, takt, 0);
}
