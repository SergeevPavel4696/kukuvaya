...
import {
    polAA, polAAX, polAAY, polAB, polABA, polABAn, polABAt, polABY, polAC, polACX, polACY,
    polAD, polADC, polADCn, polADCt, polADY, polAS2, polAS2X, polAS2Y, polAS4, polAS4X, polAS4Y, polE2,
    polE4, polFI2, polFI4, polSBY, polSDY, polVA, polVAX, polVAY, polVB, polVBA, polVBY, polVC, polVCX,
...
const
    ...
    uskAX = polAAX(t), uskAY = polAAY(t), uskS2X = polAS2X(t), uskS2Y = polAS2Y(t), uskBY = polABY(t),
    uskCX = polACX(t), uskCY = polACY(t), uskS4X = polAS4X(t), uskS4Y = polAS4Y(t), uskDY = polADY(t);
...
const contentTag =
    ...
    pol2_1([
        ...
        polPostrSkTochkiZvena("postr_VS4CVS4", "D", "C", 2, CS4, CD, false, true)
    ], ["A", OA, skA], 2, n1, skW1) +
    pol2_2([
        ["BA", "plvba", "muv1", skBA],
        ["B", "plvb", "muv2", skB],
    ...
    pol2_3([
        ...
        polPostrUskTochkiZvena("postr_AS4CAS4", "D", "C", 2, CS4, CD, false, true)
    ]) +
    pol2_4([
...
zadPlNaStr(
    [skAX, skCX], [skAY, skBY, skCY, skDY], 500,
...
zadPlNaStr(
    [uskAX, uskCX, uskAX - uskBAn * Math.cos(FI2), uskCX - uskDCn * Math.cos(FI4)],
